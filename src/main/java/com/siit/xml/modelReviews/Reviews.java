 ...
 *       &lt;sequence>
 *         &lt;element name="reviews" type="{http://localhost:8080/Reviews}TReview" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Reviews {
    ...
    protected List<TReview> reviews;
    ...
    public List<TReview> getReviews() {
        if (reviews == null) {
            reviews = new ArrayList<TReview>();
        }
        return this.reviews;
    }
