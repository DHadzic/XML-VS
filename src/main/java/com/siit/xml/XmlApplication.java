...
public class XmlApplication {
	...
	public static void testSparql() {
		...
		pub2.setStatus("u akciji");

		try {
			RDFSerialiser.saveFuseki(pub1);
			RDFSerialiser.saveFuseki(pub2);
		...
		for (String publicationID : SparqlUtil.selectData("Publications", "Username2",
				"?author = <http://siit.xml/user/Username2>")) {
